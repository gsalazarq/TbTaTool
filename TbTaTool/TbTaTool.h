...
// Mon Apr 18 01:02:57 2016 by ROOT version 5.34/05
...
Int_t TbTaTool::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TbTaTool::LoadTree(Long64_t entry)
{
...
void TbTaTool::Show(Long64_t entry)
{
...
Int_t TbTaTool::Cut(Long64_t entry)
{
